...
/**
  ...
  * 2024/10/19 加入分拣任务与usb通信，见sort_motor.c、sort_servo.c.Nano数据为缓冲区
	数据。 缓冲区数据取自usbd_cdc_if.c中的UserRxBufferFS。
  * 2024/10/23 与算法联调成功
  * 2024/10/24 加入了传送带运输任务，见belt_motor.c
  * 2024/11/12 在sort_motor.h中加入自动回正
  * 2024/11/24 加入激光测距任务，见laser_distance.c
  * 2024/11/24 加入串口屏，待联调。
	* 2025/02/15 加入向PC端发送数据的部分，见sort_motor.c
	* 2025/02/28 激光传感器控制板测试成功。
  ******************************************************************************
  */
